...
# Check ARM GCC toolchain version compatibility (ufficiale: 12.2–12.3; altre versioni solo avviso)
if(CMAKE_CXX_COMPILER_ID STREQUAL "GNU")
    if(CMAKE_CXX_COMPILER_VERSION VERSION_GREATER_EQUAL "12.2.0" AND CMAKE_CXX_COMPILER_VERSION VERSION_LESS "12.4.0")
        # Versione supportata dal firmware MetaModule
    else()
        message(WARNING
            " ARM GCC ${CMAKE_CXX_COMPILER_VERSION}: l'SDK MetaModule è testato con la toolchain 12.2 o 12.3.\n"
            " Se il build o il plugin su hardware falliscono, installa la 12.3 e imposta TOOLCHAIN_BASE_DIR sulla sua cartella bin.\n"
